...
public class GraphUtil {
     ...
     * @throws ApplicationException the file format is incorrect or the file cannot be opened
     */
    ...
    private static Edge parseOneEdge(List<String> line, Graph net) {
        Edge retVal = null;
        Integer i = 0;
        ...
        ++i;
        retVal = new Edge(net);
        retVal.from = net.nodes.get(line.get(i));
        ++i;
        ...
        retVal.to = net.nodes.get(line.get(i));
        ++i;
    ...
    public static String fromPetriNet(Graph value) {
        ...
        Iterator<String> it = value.nodes.keySet().iterator();

        while(it.hasNext())
        {
            retVal += toString(value.nodes.get(it.next())) + "\n";
        }
    ...
    private static String toString(Node p) {
        ...
        return "n " + f(p.x) + " " + f(p.y) + " " + p.sign + " n" + lbl;
    }
    ...
    public static Graph fromClipboard() {
        ...
        Transferable clipBoardContents = c.getContents(RoutingDemo.getInstance());
        Graph retVal = null;
    ...
    public static void toClipBoard(Graph net) {
        ...
        c.setContents(new StringSelection(fromPetriNet(net)), (RoutingDemo)RoutingDemo.getInstance());
    }
