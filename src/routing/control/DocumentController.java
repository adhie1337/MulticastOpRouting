...
public class DocumentController {
     ...
     * @throws ApplicationException when an error is raised during the read (like file doesn't exist or file not readable)
     */
     ...
     * @throws ApplicationException when the document is null, or an error occured while writing the file
     */
     ...
     * @throws ApplicationException when an error occured while writing the file
     */
    ...
    {
        return (MainFrame)RoutingDemo.getApplication().getMainView();
    }
